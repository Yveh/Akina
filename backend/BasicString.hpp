...
public:
	...
	~String()=default;
	inline int cmp(const String &other) const {return strcmp(ch,other.ch);}
	...
	inline unsigned short ToTime(){return ch[0]*600+ch[1]*60+ch[3]*10+ch[4]-32208;}
...
String<5> StrTime(unsigned short t)
{
	String<5> x;
	t=t%1440;
	x[0]=t/600+48;
...
std::string StrDate(unsigned short t)
{
    if(t<=30){
